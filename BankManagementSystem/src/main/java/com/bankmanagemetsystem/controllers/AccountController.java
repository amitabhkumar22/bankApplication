...
public class AccountController {
	...
	public BaseResponse updateProfile(@RequestBody UserDetails details) {
		try {
			return service.updateProfile(details);
		} catch (Exception e) {
			System.out.println("Exception occured while updating the profile user controller");
		}
		return new BaseResponse("Something went wrong", 500);
	}
